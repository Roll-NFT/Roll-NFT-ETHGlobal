...
contract RollParticipationTokenV0 is ERC721 {
    ...
    event RollParticipationTokenMinted(address sender, uint256 tokenId, string rollId, string ticketId);

    event PrizeClaimed(address sender, uint256 tokenId, string rollId, string ticketId);

    constructor() payable ERC721("Roll Participation Token Collection", "RPT") {
